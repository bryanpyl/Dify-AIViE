...
const Form = () => {
  ...
  return (
    <div className='flex w-full flex-col gap-y-4 px-20 py-8 sm:w-[960px]'>
      ...
      {((permissions.knowledgeGeneralSettings.view && permissions.knowledgeGeneralSettings.edit) || (permissions.knowledgeAdvancedSettings.view && permissions.knowledgeAdvancedSettings.edit)) && (
        <>
          <Divider
            type='horizontal'
            className='my-1 h-px bg-divider-subtle'
