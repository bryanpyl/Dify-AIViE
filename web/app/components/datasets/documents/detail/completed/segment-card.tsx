        ...
        <>
          ...
          {!isFullDocMode
            ? <div className='flex items-center'>
              ...
              {embeddingAvailable && (permissions.knowledgeDocumentManagement.edit || permissions.knowledgeDocumentManagement.delete) && (
                <div className="absolute -top-2 -right-2.5 z-20 hidden group-hover/card:flex items-center gap-x-0.5 p-1
                  ...
                  {!archived && (
                    <>
                      ...
                      {permissions.knowledgeDocumentManagement.delete && (
                        <Tooltip
                          popupContent='Delete'
                          popupClassName='text-text-secondary system-xs-medium'
                        >
                  ...
                  >
                    <Switch
                      size='md'
                      disabled={archived || detail?.status !== 'completed' || !permissions.knowledgeDocumentManagement.edit}
